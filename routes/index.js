...
// Routes  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Get  --------------------------------------------------------------------------------------------------------------------------------------------
router.get('/', (req, res) => {                 //This will be our app's response to GET requests made to the root of our application. The route takes two parameters: the actual request, and our response.
    // res.send('Hello Woarld');  // While building, our first iteration will simply send this message, which will be rendered as text.
    res.render('index');        //We send the Response of rendering our routes/index.ejs page
});
